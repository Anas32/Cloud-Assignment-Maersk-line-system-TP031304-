...
{
    public partial class UpdateShipmentStatus : System.Web.UI.Page
    {
        ...
        public DataTable getData()
        {
            try
            {
                using (con = new SqlConnection(conn))
                {
                    ...
                    string query = "select PackageID from Shipment";
        ...
        {
            string idxx = piD.SelectedValue.ToString();
            string ix = ddl.SelectedValue.ToString();
            try
            {
                using (con = new SqlConnection(conn))
                {
                    ...
                    //create new command
                    string query = "Update Shipment set status=@stat where PackageID=@pid ";
                    cmd = new SqlCommand(query, con);
                    cmd.Parameters.AddWithValue("@stat", ix);
                    cmd.Parameters.AddWithValue("@pid", idxx);
                    cmd.ExecuteNonQuery();
